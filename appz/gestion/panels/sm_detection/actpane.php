...
$ms = new ModificateurSelect('DETECTION', '', true, 'modificateurs1');
$ms2 = new ModificateurSelect('DETECTION2', '', true, 'modificateurs2');
...
<div class="mainTitle">Jet de détection</div>
...
<div class="smallCol" style="width: 200px;">
    ...
    <div class="editItem">
	<div class="label">Palier du sonar</div>
	<div class="form">
...
<?php
    ...
    $modificateurs2 = array();
    if(isset($_POST['modificateurs2'])){
	$modificateurs2 = $_POST['modificateurs2'];
    }
    
    $modificateurs = ArrayTools::merge($modificateurs1, $modificateurs2);
