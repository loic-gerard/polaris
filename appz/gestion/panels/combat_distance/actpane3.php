...
<div class="smallCol" style="width: 200px;">
    ...
    <?php
    echo '<br><br><a class="actBlueButton" href="javascript:addProgressionPoint(\''.$_GET['idAttaquant'].'\',\'TALENT\',\''.$attaquant->getTalentCodeArmeDistance().'\');">Réussite ou échec critique</a>';
    ?>
</div>