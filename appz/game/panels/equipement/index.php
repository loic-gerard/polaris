...
use polarisapi\ui\utils\BlocList;
...
$view = new View(
        ...
        'ASC', 
        '', 
        array('ARMECORPSACORPS_DESIGNATION','ARMECORPSACORPS_TYPE','ARMECORPSACORPS_TALENT','ARMECORPSACORPS_DEGATSPHYS','ARMECORPSACORPS_DEGATSCHOC','ARMECORPSACORPS_RESISTANCE', 'ARMECORPSACORPS_EQUIPED', 'ARMECORPSACORPS_SPECIAL'),
        $selectedPlayer);
$wt = new BlocList(
        'itemtemplates/armecontact.php',
        $view, 
        array('ARMECORPSACORPS_DESIGNATION' => 'Designation','ARMECORPSACORPS_TYPE' => 'Type','ARMECORPSACORPS_TALENT' => 'Talent','ARMECORPSACORPS_DEGATSPHYS' => 'Dégats physiques','ARMECORPSACORPS_DEGATSCHOC' => 'Dégats choc','ARMECORPSACORPS_RESISTANCE' => 'Resistance', 'ARMECORPSACORPS_SPECIAL' => 'Special'), 
        true,
